...
void App::FinishUpdate()
{
	...
	sprintf_s(title, 256, "Av.FPS: %.2f Last Frame Ms: %02u Last sec frames: %i Last dt: %.3f Time since startup: %.3f Frame Count: %I64u cameraY %d player y%d",
		averageFps, lastFrameMs, framesOnLastSecond, dt, secondsSinceStartup, frameCount, app->render->camera.y, app->player->position.y);
